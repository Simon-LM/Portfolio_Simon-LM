...
import { A11Y_INIT_OPTIONS } from "@/config/accessibilityPreferences";
	...
	return (
		<>
			...
			{/* Anti-FOUC script: string generated by the package (E4 phase 3).
			    Also restores the typography — dyslexia class, text size,
			    accessibility font — before the first paint. Applying those
			    after hydration flashed unreadable text at exactly the person
			    who set them to avoid it. */}
			<Script
				id="theme-script"

...
| [PLAN-css-conventions.md](./PLAN-css-conventions.md) | Execution plan: opt-in SCSS/CSS conventions layer (functions, mixins, placeholders) + Tailwind v4 utilities + portfolio migration — starts the extreme-zoom entry parked in TODO.md | 🚧 opened 2026-08-04, step 0 (plan) accepted |
| [INVENTORY-css-conventions.md](./INVENTORY-css-conventions.md) | Step 1 of that chantier: full sweep of every clamp, viewport unit, px, gap and media query, before any convention is named — 5 clamp dialects, 2 extreme-zoom defects, 4 incidental bugs | 🚧 produced 2026-08-06 (branch `feat/css-conventions`), awaiting Simon's call on the 5 questions |
